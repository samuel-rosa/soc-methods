...
Bemmelen factor, 1.724, which relies on the assumption that soil organic matter is composed of 58% of carbon, 
is commonly used to transform organic carbon content to organic matter content [@Pribyl2010]. Similar 
...
of standard dry combustion methods [@FrattiniEtAl1967; @VerlengiaEtAl1968; @PereiraEtAl2006; 
@RheinheimerEtAl2008; @GattoEtAl2009].
...
themselves are linear regression models based on the assumption that the regression line passes through the 
origin [@Pribyl2010]. In Brazil, additionaly to conversion factors, many linear regression models have been 
