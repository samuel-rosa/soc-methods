...
We first download the necessary data to prepare the figure. This includes shapefile of the limits of the 
state of Rio Grande do Sul, downloaded from IBGE geoservices, and a digital elevation model of the state
of Rio Grande do Sul, prepared by the Geoprocessing Laboratory of the Federal University of Rio Grande do Sul.
We also process the observations, so that observations from the same municipality are discarded for plotting.
...
n <- unique(dem) %>% length()
col <- terrain.colors(n, alpha = 0.50)
