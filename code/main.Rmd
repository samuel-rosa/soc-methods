...
microtubes (Eppendorf type) in the dark at room temperature until analysis. A description of the soil sampling
...
(> 800 m a.s.l.) and warmer in lower sites (< 200 m a.s.l.). Finnaly, five of the most common land use types 
found in RS are represented: animal husbandry, annual crop agriculture (rice, soya, mayze, wheat), various 
...
Many secondary features of the set of soil samples arise from Figure \@ref(fig:soil-features). For exemple, a
large proportion of soil samples has a clay content between 150 and 650 g kg^-1^. This likely indicates that
fewer soil reasearch has been conducted in the DS-UFSM under conditions of very low or very high clay content.
