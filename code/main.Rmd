...
Bemmelen factor, 1.724, which relies on the unrealistic assumption that soil organic matter is composed of 58%
...
The recent Brazilian scientific literature lacks studies on the comparison of methods for measuring soil 
carbon and organic matter content and to estimate conversion factors between analytical methods. We think that
this should be a reason for soil scientists to worry because it means that some pedotransfer functions may be 
being employed in soil conditions very different from those in which they have been estimated. Consider, for 
example, the southernmost Brazilian state, Rio Grande do Sul (RS), where three of such studies have been 
developed more recently. The first, conducted by @BrunettoEtAl2006, used *n* = 19 samples of the Serra Gaúcha 
region (clay = 210-530 g kg^-1^; organic matter = 2.9-13.3%). The second, carried out by 
@EscosteguyEtAl2007, employed only *n* = 19 samples to represent the entire territory of RS 
(clay = 89-729 g kg^-1^), and another *n* = 49 samples from the Central Depression region (coarse texture) -- 
in both dataset the organic matter content was below 5.5%. Finally, @RheinheimerEtAl2008 used *n* = 18 samples
from the Planalto region (fine texture) and another *n* = 75 samples from the Central Depression region, their 
organic matter content being bellow 7.0%.
