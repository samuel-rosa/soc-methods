...
B. y ~ x + x^2
C. y ~ x + x^2 + topsoil
D. y ~ x + x^2 + topsoil + landuse
E. y ~ x*clay + x^2*clay + topsoil + landuse
F. y ~ x*clay + x^2*clay + topsoil + landuse + taxon
...
formulas <- lapply(1:nrow(soil_vars), function (i) {
  ...
  list(
    glue("{y} ~ {x}"), # A
    glue("{y} ~ {x} + I({x}^2)"), # B
    glue("{y} ~ {x} + I({x}^2) + topsoil"), # C
    glue("{y} ~ {x} + I({x}^2) + topsoil + {landuse}"), # D
    glue("{y} ~ {x}*clay + I({x}^2)*clay + topsoil + {landuse}"), # E
    glue("{y} ~ {x}*clay + I({x}^2)*clay + topsoil + {landuse} + {taxon}") # F
    )
})
...
cross_validation$f[which.min(cross_validation$mAVE)]
```
