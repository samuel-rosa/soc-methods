...
for (i in 1:length(forms)) {
  fit[[i]] <- rq(forms[[i]], data = camada, method = 'fn')
}
...
panderOptions('round', rep(4, ncol(betas)))
panderOptions('table.split.cells', rep(100 / ncol(betas), ncol(betas)))
pander(betas, caption = '(\\#tab:coefficients) Estimated coefficients of soil carbon and organic matter pedotransfer functions and their respective lower and upper bounds. Coefficients of the $\\tau = 0.5$ quantile regression models are as follows: $\\Beta_0$ -- intercept, $\\Beta_1$ -- soil carbon and organic matter content.')
```
